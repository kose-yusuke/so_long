...
/*   Updated: 2024/03/02 17:39:06 by ykoseki          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (keycode == UP)
		ft_update_position(mgr, mgr->player_pos.x_pos, mgr->player_pos.y_pos
			- 1);
	else if (keycode == DOWN)
		ft_update_position(mgr, mgr->player_pos.x_pos, mgr->player_pos.y_pos
			+ 1);
	else if (keycode == LEFT)
		ft_update_position(mgr, mgr->player_pos.x_pos - 1,
